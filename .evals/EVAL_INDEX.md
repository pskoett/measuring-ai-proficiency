...
|---------|--------|--------|--------|---------|
| [EVAL-007](.evals/cases/EVAL-007.md) | `LRN-003` GraphQL page-size guardrail (`.learnings/LEARNINGS.md`, 2026-05-23) | `AGENTS.md` | grep-check | `GitHub GraphQL connections cap \`first\` at 100 records.` |
