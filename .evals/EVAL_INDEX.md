...
| [EVAL-007](.evals/cases/EVAL-007.md) | LRN-003 GitHub GraphQL connection page-size rule | `AGENTS.md` | grep-check | `GitHub GraphQL connections cap \`first\` and \`last\` at 100.` |
